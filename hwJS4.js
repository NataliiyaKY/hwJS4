...
function tableNum(tableTextNum, num) {
    document.write(`<ul>`)
    for (let j = 0; j < num; j++) {
...
function sumCalculator(totalArray) {
    let sum = 0
...
function exchange(amount, dataForCalc, currencyForCalc) {
